		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "V4 Odata Skill Tracker App",
									"targetURL": "#commindsetjuliettev4skilltracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetjuliettev4skilltracker-display": {
								"semanticObject": "commindsetjuliettev4skilltracker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.juliette.v4skilltracker",
									"url": sap.ui.require.toUrl("com/mindset/juliette/v4skilltracker")
								}
							}
						}
					}
